  ...
  return !isLoading ? (
    <div className='relative px-6 md:px-16 lg:px-40 pt-30 md:pt-40 min-h-[80vh]'>
      ...
      {bookings.map((item, index) => (
        <div key={index} className='flex flex-col md:flex-row justify-between bg-primary/8 mt-4 p-2 border border-primary/20 rounded-lg max-w-3xl'>
          ...
          <div className='flex flex-col md:items-end md:text-right justify-between p-4'>
            <div className='flex items-center gap-4'>
              ...
              {!item.isPaid && <button className='bg-primary text-sm py-1.5 px-4 rounded-full font-medium cursor-pointer '>Pay Now</button>}
            </div>
